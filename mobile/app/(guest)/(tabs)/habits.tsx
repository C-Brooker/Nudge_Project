...
export default function HomeScreen() {
  ...
  // Updated render functions that properly use the view state
  const renderCountHabit = useCallback(
    ...
    [view] // Include view in dependencies so it re-renders when view changes
  );
  ...
  const renderQuitHabit = useCallback(
    ...
    [] // Quit habits don't change based on view
  );

  const addHabit = () => {
    router.navigate("/(guest)/(tabs)/habit/name");
  };
